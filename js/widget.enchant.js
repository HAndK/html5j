const LIST_ITEM_BG_PNG = 'img/listItemBg.png';
const ICON_MENU_BG_PNG = 'img/iconMenuBg.png';
const BUTTON_PNG = 'img/button.png';
const BUTTON_PUSHED_PNG = 'img/buttonPushed.png';
const DIALOG_PNG = 'img/dialog.png';
const NAVIGATION_BAR_PNG = 'img/navigationBar.png';
...
(function() {
    ...
    enchant.widget.Button = enchant.Class.create(enchant.widget.EntityGroup, {
        ...
        initialize: function(content) {
            ...
            bg1.src = core.assets[BUTTON_PNG];
            this.image = bg1;

            var bg2 = new enchant.widget.Ninepatch(minwidth, minheight);
            bg2.src = core.assets[BUTTON_PUSHED_PNG];
    ...
    enchant.widget.Input = enchant.Class.create(enchant.Entity, {
         ...
         * @param {String} type <input>のtype.
         * @constructs
         * @extends enchant.Entity
         */
    ...
    enchant.widget.ListItem = enchant.Class.create(enchant.widget.ListElement, {
        ...
        initialize: function(width, height, content, icon, rightIcon) {
            ...
            var np = new enchant.widget.Ninepatch(this.width, this.height);
            np.src = core.assets[LIST_ITEM_BG_PNG];
            this.background = np;
        },
        /**
         * Renew changes.
